  ...
  return (
    <>
      ...
      <div className="txt-cont">
        ...
        <h4>ESCUELA: AUM IZTAPALAPA</h4>
        <p>
          2015-2019 UNIVERSIDAD AUTÓNOMA METORPOLITANA, UNIDAD IZTAPALAPA.
          Licenciatura en matemáticas (TRUNCA). </p>

        <h4>ESCUELA: IPN UPIICSA.</h4>
        <p>2022 - 2024 INSTITUTO POLITECNICO NACIONAL, UPIICSA.
          Licenciatura en Ciencias de la informática.</p>
        <h4>ESCUELA: DEV-F.</h4>
