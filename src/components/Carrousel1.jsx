...
import imagen from '../assets/ipn3.png'
...
const Carrousel1 = () => {
  return (
    <div className="carousel-container">
      ...
      >
        <div >
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSuMCpITns7bRKBV_bTORd5ROq5GgSM7wispQ&usqp=CAU" alt="Imagen 1" className='imgwork'/>
